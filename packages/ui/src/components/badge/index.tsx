...
const badgeVariants = cva(
  'flex h-6 select-none items-center rounded-md border px-3 py-1 text-xs font-medium transition-colors',
  {
    variants: {
      variant: {
        disabled:
          'border-neutral-500 bg-neutral-600/40 text-neutral-300 shadow hover:bg-neutral-600/80',
        info: 'border-sky-600 bg-sky-600/20 text-sky-400 hover:bg-sky-600/80',
        warning:
