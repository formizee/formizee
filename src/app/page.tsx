    ...
    <main className="flex bg-black min-h-screen flex-col items-center justify-center p-24">
      ...
      <header className="flex flex-col gap-y-8 items-start">
        <div className="flex flex-col gap-3">
          <h1 className="text-transparent bg-clip-text leading-snug text-5xl bg-gradient-to-b from-white to-slate-400 font-semibold">
            Forms Backend
            <br />
          ...
          <p className="w-full text-neutral-400 text-lg">
            ...
            <br /> Smooth, Effortless and Open Source.
          </p>
        </div>
