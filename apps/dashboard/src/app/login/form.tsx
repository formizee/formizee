...
import {ArrowRightIcon, UndoIcon} from '@formizee/ui/icons';
      ...
      <form className="flex flex-col gap-4 w-full" onSubmit={onSubmit}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          <Button
            ...
            onClick={async () => githubLogin(redirectTo)}
          >
            Login With Github
            <svg className="size-4" fill="currentColor" viewBox="0 0 256 250">
          ...
          <Button
            ...
            type="button"
            className="w-full text-neutral-950 dark:text-neutral-50"
            onClick={async () => googleLogin(redirectTo)}
          >
            Login With Google
            <svg className="size-4" fill="currentColor" viewBox="0 0 256 262">
