...
export const SettingsNavbar = (props: SettingsNavbarProps) => {
  return (
    <nav className="z-50 border-b border-b-neutral-200 dark:border-b-neutral-800 dark:border-b-neutral-800 dark:border-b-neutral-800 bg-neutral-50/[.01] dark:bg-neutral-950/[0.01] flex flex-row justify-between w-full backdrop-blur-lg pr-[1px] fixed">
