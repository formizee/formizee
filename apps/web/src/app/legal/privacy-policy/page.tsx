...
function PrivacyPolicy(): JSX.Element {
  return (
    <div className="flex flex-col gap-y-4 text-neutral-400">
      ...
      <strong className="font-medium text-neutral-50">Payment Data</strong>{' '}
      <p>
      ...
      <p>
        All payment data is stored by Stripe. To know how Stripe manages your
        data, visit his{' '}
        <Link
          className="underline underline-offset-2"
      ...
      <p>
        Our servers are located in Germany, and United States. If you are
        accessing our Services from outside Germany, and United States, please
        ...
        we may share your personal information, in other countries.
      </p>
      <p>
      ...
      <p>
        ...
        such minor dependent&rsquo;s use of the Services.
      </p>
      <p>
      ...
      <p>
        ...
        decision, please email us at support@formizee.com. Within sixty (60)
