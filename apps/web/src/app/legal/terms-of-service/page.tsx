...
function TermsOfService(): JSX.Element {
  return (
    <div className="flex flex-col gap-y-4 text-neutral-400">
      <h1 className="bg-gradient-to-b from-white to-neutral-400 bg-clip-text text-4xl sm:text-5xl font-medium text-transparent">
        Terms Of Service
      </h1>
      ...
      <p>
        ...
        Services; (5) you will not access the Services through automated or
      ...
      <strong className="font-medium text-neutral-50">Cancellation</strong>
      <p>
        ...
        Services, please email us at support@formizee.com.
      </p>
      <strong className="font-medium text-neutral-50">Fee Changes</strong>
      <p>
      ...
      <p>
        ...
        Services are hosted in Germany and United States. If you access the
        ...
        differ from applicable laws in Germany and United States, then through
      ...
      <p>
        ...
        Valencia, Spain. The language of the proceedings shall be English.
        Applicable rules of substantive law shall be the law of Spain.
      </p>
      <strong className="font-medium text-neutral-50">Restrictions</strong>
      <p>
