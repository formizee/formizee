...
export function Footer() {
  return (
    <footer className="flex flex-col sm:flex-row w-full p-12 mt-12 border-t dark:border-neutral-800">
      <div className="flex flex-row gap-12 mb-8 justify-between sm:gap-0 sm:flex-col min-w-56">
        ...
        <div className="my-6 flex flex-row gap-2">
          ...
          <Button asChild size="icon" variant="outline">
            <Link href="https://bsky.app/profile/formizee.com" target="_blank">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-[repeat(auto-fit,minmax(0,auto))] gap-10 sm:px-10 w-full">
        <nav>
