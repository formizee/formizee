...
import {CodeIcon} from '@formizee/ui/icons';
import Link from 'next/link';

export function Footer() {
  return (
    <footer className="flex flex-row w-full p-12 mt-12 border-t">
      ...
      <div className="flex flex-row px-24 w-full justify-between">
        <nav>
