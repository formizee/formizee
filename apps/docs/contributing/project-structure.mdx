...
<img className="block h-72 dark:hidden" src="../assets/project-structure-light.png" alt="Formizee Architecture" />
<img className="hidden h-72 dark:block" src="../assets/project-structure-dark.png" alt="Formizee Architecture" />
